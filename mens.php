...
<head>
    ...
    <link href="kiji.css" rel="stylesheet">
...
<body>
    ...
    <div class="img">
        <div class="farst">
            <img src="img/tow.jpg" alt="モデル写真">
            <p>カラー、カット募集しています。毛先だけ切りたい、カラーはしたいけど、よく分からないなら相談だけでも致します。</p>
        </div>
        <div class="second">
            <img src="img/three.jpg" alt="モデル写真">
            <p>
        ...
        <div class="tree">
            <img src="img/one.jpg" alt="モデル写真">
            <p>DMでは話ずらい方、緊張する方もいるかもしれません。そんな方はこちらからご相談させて頂きます！↓</p>
        </div>
    </div>
    <div class="yoyaku">
        <a href="yoyaku.php">こちら</a>
    </div>
    <footer>
