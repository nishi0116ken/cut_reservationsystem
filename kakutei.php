...
<html lang="ja">
    ...
    <header><a href="index.php">Nakamura Beauty</a></header>
        ...
        <div class="massage">
            ...
            $honbun .= "氏名:.$name.'様\n";
            $honbun .= "性別:.$sex.\n";
            $honbun .= "SNSアカウント:.$insta.\n";
            $honbun .= "メニュー:.$syurui.\n";
            $honbun .= "希望ヘアスタイル:.$hair_style.\n";
            $honbun .= "希望ヘアカラー:.$hair_color.\n";
            $honbun .= "ご要望:.$remarks.\n";
            $honbun .= "\n";
            ...
            $honbun .= "\n";
            $honbun .= "□□□□□□□□□□□□□□□□□□□□□□□\n";
            $honbun .= " Nakamura Beauty\n";
            $honbun .= "電話番号 080-7707-5619\n";
            $honbun .= "メール nishi0116@gmail.com\n";
            $honbun .= "□□□□□□□□□□□□□□□□□□□□□□□\n";
    
            require 'vendor/autoload.php';
            $email = new \SendGrid\Mail\Mail();
            $email ->setFrom("nishi0116ken@gmail.com","Nakamura Beauty");
            $email ->setSubject("モデル予約通知");
            $email ->addTo("1007213089@skycampus.jp","中村雄樹様");
